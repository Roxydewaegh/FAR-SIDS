// The listening post entries, newest first. To add an entry, copy one block and edit it.
// place: the tag on the card · when: the date stamp · title, body: plain text, no HTML
